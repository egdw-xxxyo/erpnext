...
CREATOR_STANDARD_ROUTE_CONDITION = f"({CREATOR_TRANSITION_CONDITION}) and ({STANDARD_ROUTE_CONDITION})"
CREATOR_APPROVED_ROUTE_CONDITION = f"({CREATOR_TRANSITION_CONDITION}) and ({APPROVED_ROUTE_CONDITION})"
