...
the pair does not. A rule applied retroactively would either delete a record the register
promises never to delete, or block every future save of a row that has been fine since
2026.
"""
