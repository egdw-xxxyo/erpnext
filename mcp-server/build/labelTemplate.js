		...
		inputSchema: {
			...
			properties: {
				...
				field_mapping: {
					type: "string",
					description:
						'JSON string. Format: {"field": {"source": "spec|doc", "param": "Parameter Name", "transform": "chemistry"}}',
				},
		...
		inputSchema: {
			...
			properties: {
				category: {
					type: "string",
					description:
						"Optional category filter: Basics | Layout | Barcode | Padding | Utility classes | Full example",
				},
	...
	},
	{
		...
		inputSchema: {
			...
			properties: {
				...
				description_uk: {
					type: "string",
					description: "Short Ukrainian explanation shown above the snippet",
				},
